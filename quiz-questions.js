const easyQuizData = [
      // ... Your easy difficulty questions ...
      // (The rest of the questions data remains the same)
      {
 ...
 // Define the number of questions per game
    ...
    if (difficulty === 'easy') {
      ...
      // Add the medium difficulty questions here
      // ...
    } else if (difficulty === 'hard') {
      // Add the hard difficulty questions here
      // ...
    } else {
